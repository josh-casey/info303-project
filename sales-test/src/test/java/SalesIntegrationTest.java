...
public class SalesIntegrationTest {
	...
	public void testCreateSale() throws IOException {
		Response<Sale> addRsp = sales.addNewSale(sale4).execute();
		assertThat("add operation succeeded", addRsp.isSuccessful(), is(true));
		assertThat("response code should be 201", addRsp.code(), is(201));

		Response<List<Sale>> salesRsp = customers.getCustomerSales(cust1.getId()).execute();
		...
		Response<Sale> duplicateRsp = sales.addNewSale(sale4).execute();
	...
	public void testDeleteSale() throws IOException {
		...
		salesRsp = customers.getCustomerSales(cust1.getId()).execute();
	...
	public void testGetSummary() throws IOException {
		Response<Summary> summaryRsp = customers.getCustomerSummary(cust1.getId()).execute();
